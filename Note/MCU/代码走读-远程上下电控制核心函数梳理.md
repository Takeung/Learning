...
- [代码走读-远程上下电控制核心函数梳理](#代码走读-远程上下电控制核心函数梳理)
  - [main函数](#main函数)
    ...
    - [-\>**MyInit**](#-myinit)
      ...
      - [-\>**UART\_Init\_With\_Interrupt**：初始化并配置UART中断，包括GPIO\_PRT32、3、23、12以及15](#-uart_init_with_interrupt初始化并配置uart中断包括gpio_prt3232312以及15)
